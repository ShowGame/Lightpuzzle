...
export const MOCK_PLAYER_DATA: {
    ...
    opticalCurrentLevelId: 11,
    /** 1/2/3/5 已通；4/6 未在表中 → 选关锁定；无 999999 占位也可，有真实步数即视为已解锁 */
    opticalLevelClears: [1, 1, 2, 999999, 3, 999999, 4, 999999, 5, 999999, 6, 999999, 7, 999999, 8, 999999, 9, 999999, 10, 999999, 11, 999999, 12, 999999, 13, 999999],
};
